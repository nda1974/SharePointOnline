...
namespace SPOApp
{
    public static class Enterprise
    {
        ...
        public static List<EnterpriseManualProperies> GetSourceFiles(ClientContext context, string sourceLibraryName)
        {
            ...
            List<EnterpriseManualProperies> pages = new List<EnterpriseManualProperies>();
        ...
        public static void CreateModernSitePages(ClientContext context, List<EnterpriseManualProperies> pages)
        {

            //List<AnsvarManualProperies> sourcePages = pages;
            string targetContentTypeName = "EnterpriseManual";
