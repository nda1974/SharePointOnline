define(["require", "exports", "tslib", "react", "../../../Utilities", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/FocusTrapZone", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/TextField", "office-ui-fabric-react/lib/Toggle"], function (require, exports, tslib_1, React, Utilities_1, Button_1, FocusTrapZone_1, Link_1, TextField_1, Toggle_1) {
    "use strict";
        ...
        BoxExample.prototype._internalContents = function () {
            ...
            return (React.createElement("div", { className: 'ms-FocusTrapZoneBoxExample' },
                ...
                React.createElement("div", { className: 'shouldFocus input' },
                    React.createElement(Toggle_1.Toggle, { componentRef: function (t) { return _this._toggle = t; }, checked: isChecked, onChanged: this._onFocusTrapZoneToggleChanged, label: 'Focus Trap Zone', onText: 'On', offText: 'Off' })),
                (function () {
                    if (isChecked) {
