    ...
    var BoxExample = (function (_super) {
        ...
        BoxExample.prototype._internalContents = function () {
            ...
            return (React.createElement("div", { className: 'ms-FocusTrapZoneBoxExample' },
                ...
                React.createElement("br", null),
                React.createElement(Toggle_1.Toggle, { componentRef: function (toggle) { return _this._toggle = toggle; }, checked: isChecked, onChanged: this._onFocusTrapZoneToggleChanged, label: 'Focus Trap Zone', onText: 'On', offText: 'Off' }),
                (function () {
                    if (isChecked) {
