...
export declare class ContextualMenu extends BaseComponent<IContextualMenuProps, IContextualMenuState> {
    ...
    private _renderNormalItem(item, index, focusableElementIndex, totalItemCount, hasCheckmarks, hasIcons);
    private _renderHeaderMenuItem(item, index, hasCheckmarks, hasIcons);
    private _renderAnchorMenuItem(item, index, focusableElementIndex, totalItemCount, hasCheckmarks, hasIcons);
    private _renderButtonItem(item, index, focusableElementIndex, totalItemCount, hasCheckmarks?, hasIcons?);
