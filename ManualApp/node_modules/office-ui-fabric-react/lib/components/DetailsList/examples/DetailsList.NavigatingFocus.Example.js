...
var DetailsListNavigatingFocusExample = (function (_super) {
        ...
        _this._columns = [
            {
                ...
                onRender: function (item) {
                    return React.createElement(Link_1.Link, { key: item, onClick: function () { return _this._navigate(item); } }, item);
                },
            },
            {
                name: 'Size',
    ...
    DetailsListNavigatingFocusExample.prototype._navigate = function (name) {
        this.setState({
