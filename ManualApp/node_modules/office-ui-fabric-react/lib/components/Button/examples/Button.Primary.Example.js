...
var ButtonPrimaryExample = (function (_super) {
    ...
    ButtonPrimaryExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'ms-BasicButtonsExample' },
            ...
            React.createElement(Button_1.PrimaryButton, { "data-automation-id": 'test', disabled: disabled, checked: checked, text: 'Create account', onClick: function () { return alert('Clicked'); } })));
    };
