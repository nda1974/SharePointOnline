...
var WriteManifestsTask = (function (_super) {
        ...
        this.properties.deployEntries.forEach(function (deployEntry) {
            ...
            componentKeys.forEach(function (id) {
                ...
                if (shouldProduceDebugManifests) {
                    ...
                    //  production build
                    _this.buildConfig.production ? undefined : _this.taskConfig.debugLocale, !_this.buildConfig.production);
                ...
                if (shouldProduceProductionManifests) {
                    bundleComponent.manifestData = _this._getLocalizedManifest(bundleComponent.manifestData, constants_1.default.defaultLocale);
     ...
     */
    WriteManifestsTask.prototype._getLocalizedManifest = function (manifest, defaultLocale, onlyUseDefaultLocale) {
        var manifestClone = _.cloneDeep(manifest);
        switch (manifestClone.componentType) {
            case 'WebPart':
                this._localizeWebPartManifest(manifestClone, // tslint:disable-line:no-any
                defaultLocale, onlyUseDefaultLocale);
                break;
            case 'Application':
                this._localizeApplicationManifest(manifestClone, defaultLocale, onlyUseDefaultLocale);
                break;
            case 'Extension':
                this._localizeExtensionsManifest(manifestClone, defaultLocale, onlyUseDefaultLocale);
                break;
        }
     ...
     */
    WriteManifestsTask.prototype._localizeWebPartManifest = function (manifest, // tslint:disable-line:no-any
        defaultLocale, onlyUseDefaultLocale) {
        var _this = this;
        // tslint:disable-next-line:no-any
        manifest.preconfiguredEntries.forEach(function (entry) {
            entry.title = _this._localizeString(entry.title, defaultLocale, onlyUseDefaultLocale);
            entry.description = _this._localizeString(entry.description, defaultLocale, onlyUseDefaultLocale);
            if (entry.group) {
                entry.group = _this._localizeString(entry.group, defaultLocale, onlyUseDefaultLocale);
            }
        });
    };
    /**
     ...
     */
    WriteManifestsTask.prototype._localizeApplicationManifest = function (manifest, defaultLocale, onlyUseDefaultLocale) {
     ...
     */
    WriteManifestsTask.prototype._localizeExtensionsManifest = function (manifest, defaultLocale, onlyUseDefaultLocale) {
     ...
     */
    WriteManifestsTask.prototype._localizeString = function (stringToLocalize, defaultLocale, onlyUseDefaultLocale) {
        ...
        if (matches && matches.length === 3) {
            ...
            /* stringId */ matches[0]);
            if (defaultLocale) {
                localizedStrings['default'] = localizedStrings[defaultLocale]; // tslint:disable-line:no-string-literal
                ...
                if (onlyUseDefaultLocale) {
                    for (var _i = 0, _a = Object.keys(localizedStrings); _i < _a.length; _i++) {
                        var locale = _a[_i];
                        if (locale !== 'default') {
    ...
    WriteManifestsTask.prototype._generateLoaderConfig = function (entrypointExportName, deployModules, internalModuleBaseUrls, resolvePath, defaultLocaleOverride, onlyUseDefaultLocale) {
        var scriptResources = {};
