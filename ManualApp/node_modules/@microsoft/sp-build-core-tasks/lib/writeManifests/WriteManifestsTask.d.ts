...
export declare class WriteManifestsTask extends OdspGulpTask<IWriteManifestsTaskConfig> {
     ...
     */
    private _getLocalizedManifest(manifest, defaultLocale, onlyUseDefaultLocale?);
    /**
     ...
     */
    private _localizeWebPartManifest(manifest, defaultLocale, onlyUseDefaultLocale?);
    /**
     ...
     */
    private _localizeExtensionsManifest(manifest, defaultLocale, onlyUseDefaultLocale?);
    /**
    ...
    private _generateManifest(bundleComponent, loaderConfig);
