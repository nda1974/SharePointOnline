...
var URL_complete_1 = require("@microsoft/sp-polyfills/lib/url/experimental/URL-complete");
...
var SpfxServeTask = (function (_super) {
    ...
    SpfxServeTask.prototype.loadSchema = function () {
        ...
        var spfxServeSchema = node_core_library_1.JsonFile.load(path.join(__dirname, 'spfx-serve.schema.json'));
    ...
    SpfxServeTask.prototype._convertServeConfigurationToPageUrl = function (serveConfiguration) {
        ...
        var url = new URL_complete_1.default(serveConfiguration.pageUrl);
