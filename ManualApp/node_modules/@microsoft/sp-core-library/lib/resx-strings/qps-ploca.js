define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      "invalidEnvironmentTypeError": "***ĚŋvĭřơňmēŉťŤɏƿě ĭş įňvàļıđ",
      "invalidGuidStringError": "***Ĩńvãļįď ĠŬĮĎ ŝŧŗįņģ: \"{0}\"",
      "isFalseValidateError": "***Ťħě vãŀŭȅ ƒōř \"{0}\" ĩŝ ƒǻłŝę",
      "isNullValidateError": "***Ŧĥĕ vǻľůę ƒőř \"{0}\" mūşť ŉőţ ƅę ƞūļľ",
      ...
      "serviceScopeConsumingBeforeFinished": "***Ćåŉƞŏţ ćōƞśŭmȇ ŝȅřvīċęś ɓėċåŭšē ţħě śčōƥě ĩş ŉőť ƒĭňīŝħȅď ȳĕť",
      "serviceScopeConsumingDuringAutoCreation": "***Ćǻƞńơŧ čŏŉŝůmę śĕŗvįĉęş đűŗīńġ ŚěřvĭčȅŞĉơƿě ǻűťŏćŕėâţĩŏŉ",
      "serviceScopeAlreadyFinishedError": "***Ţĥė ŠěřvįčěŠčơƥȇ ıŝ ǻļŗȇáďŷ ƒĭƞįŝĥēđ",
      "serviceScopeProvideServiceAfterFinishedError": "***Ĉäƞŉōť ŕęĝıśŧėŗ śěřvĩĉȇ Ƅĕċåůśȇ ŧħĕ śćŏƥȅ ıś āŀŕėãđȳ ƒįŉıšĥēď",
