define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      "invalidEnvironmentTypeError": "[!!--##***ĖƞvīřőŋmėŉŧŢɏƥę ĭŝ ĩńvǻľįđ##--!!]",
      "invalidGuidStringError": "[!!--##***Ĭƞväĺĭď ĞŨĮĐ şŧŕĭŋġ: \"{0}\"##--!!]",
      "isFalseValidateError": "[!!--##***Ţħȅ vãĺũĕ ƒŏŗ \"{0}\" ĭş ƒąŀşĕ##--!!]",
      "isNullValidateError": "[!!--##***Ţĥę vǻłũę ƒōŗ \"{0}\" mũśţ ŉŏť ƅȇ ņŭŀľ##--!!]",
      "isUndefinedValidateError": "[!!--##***Ŧħę väĺŭē ƒơŗ \"{0}\" můšŧ ŋōţ Ƅě ŭņđēƒīŉĕď##--!!]",
      "isEmptyStringValidateError": "[!!--##***Ŧħē váļūȅ ƒōŕ \"{0}\" műşţ ńőť ɓȇ âņ ęmƥŧŷ šťŗıƞĝ##--!!]",
      "invalidVersionStringError": "[!!--##***Ĩŉvâĺįđ vęřšīőņ ŝŧřıƞġ: \"{0}\"##--!!]",
      ...
      "serviceScopeConsumingDuringAutoCreation": "[!!--##***Ćǻŉŋŏť ċơŋšųmę śȇřvīĉėŝ ďůŗįƞĝ ŠėŕvĭĉęŚčơƿĕ åūťŏčŗȇâťĭŏƞ##--!!]",
      "serviceScopeAlreadyFinishedError": "[!!--##***Ŧħē ŚėŕvıċěŠčőƿȇ ĭŝ ǻĺŗĕȃđŷ ƒīŋĩšĥėď##--!!]",
      "serviceScopeProvideServiceAfterFinishedError": "[!!--##***Čǻŋŉōţ ŕĕģįšŧėř şęŗvĩćě ɓėĉăūşę ŧĥȇ śčōƥȅ īś ȃŀŕęȁđƴ ƒįƞįšĥȅď##--!!]",
