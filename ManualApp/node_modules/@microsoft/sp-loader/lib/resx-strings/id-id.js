define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Aplikasi gagal dimuat. Id: \"{0}\", nama: \"{1}\".\r\nKesalahan: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Kesalahan saat memuat skrip manifes debug. Pastikan server berjalan dan URL parameter \"debugManifestsFile\" benar.",
      "errorLoadingDebugManifestHTTP": "Kesalahan saat memuat skrip manifes debug. Pastikan server berjalan dan URL parameter \"debugManifestsFile\" benar, dan pemuatan skrip yang tidak aman telah diizinkan. Pertimbangkan untuk menggunakan sertifikat pengembangan dan menjalankan skrip debug daripada HTTPS.",
      "errorLoadingDebugManifestMalformed": "Kesalahan saat memuat skrip manifest debug. Format URL debug ({0}) salah."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "\"ctrl+shift+`\" adalah tombol kombinasi untuk membuka alat pengembang yang sudah tidak berlaku dan akan segera dihapus. Gunakan tombol kombinasi \"ctrl+F12\" sebagai gantinya."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Kesalahan saat memuat manifes debug.",
      "debugManifestErrorDetail": "Terjadi kesalahan saat memuat manifes debug.",
      "debugManifestErrorDismissButtonText": "Tutup"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Izinkan skrip debug?",
      "debugLoaderLoadingTitle": "Izinkan Pemuat Debug?",
