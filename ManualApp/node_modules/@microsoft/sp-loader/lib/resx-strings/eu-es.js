define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Ezin izan da kargatu aplikazioa. IDa: \"{0}\". Izena: \"{1}\".\r\nErrorea: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Errore bat gertatu da arazketa-manifestuaren script-a kargatzean. Ziurtatu zerbitzaria martxan dagoela eta \"debugManifestsFile\" parametroko URLa zuzena dela.",
      "errorLoadingDebugManifestHTTP": "Errore bat gertatu da arazketa-manifestuaren script-a kargatzean. Ziurtatu zerbitzaria martxan dagoela, \"debugManifestsFile\" parametroko URLa zuzena dela eta seguruak ez diren script-ak kargatzea onartzen dela. Horrez gain, gomendagarria litzateke garapen-ziurtagiri bat erabiltzea eta arazteko script-ak HTTPS protokoloaren bidez hornitzea.",
      "errorLoadingDebugManifestMalformed": "Errore bat gertatu da arazketa-manifestuaren script-a kargatzean. Arazketa URLaren formatua ({0}) ez da zuzena."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Laster ezingo da erabili \"Ktrl+Maius+`\" tekla-konbinazioa garatzaileentzako tresnak irekitzeko. Horren ordez, erabili \"Ktrl+F12\"."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Errore bat gertatu da arazketa-manifestuak kargatzean.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Arazte-scriptak onartu nahi dituzu?",
      "debugLoaderLoadingTitle": "Araztaile-kargatzailea onartu nahi duzu?",
