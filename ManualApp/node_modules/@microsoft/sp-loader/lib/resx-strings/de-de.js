define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Fehler beim Laden der Anwendung. ID: \"{0}\", Name: \"{1}\".\r\nFehler: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Fehler beim Laden des Debugmanifestskripts. Stellen Sie sicher, dass der Server ausgeführt wird, und dass die URL des Parameters \"debugManifestsFile\" richtig ist.",
      "errorLoadingDebugManifestHTTP": "Fehler beim Laden des Debugmanifestskripts. Stellen Sie sicher, dass der Server ausgeführt wird, dass die URL des Parameters \"debugManifestsFile\" richtig ist, und dass das Laden unsicherer Skripts zulässig ist. Erwägen Sie außerdem die Verwendung eines Entwicklungszertifikats sowie die Verarbeitung von Debugskripts über HTTPS.",
      "errorLoadingDebugManifestMalformed": "Fehler beim Laden des Dabugmanifestskripts. Die Debug-URL ({0}) scheint ein falsches Format zu haben."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Die Tastenkombination \"STRG+UMSCHALT+`\" zum Öffnen der Entwicklertools ist veraltet und wird bald entfernt. Verwenden Sie stattdessen die Tastenkombination \"STRG+F12\"."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Fehler beim Laden von Debugmanifesten.",
      "debugManifestErrorDetail": "Fehler beim Laden des Debugmanifests.",
      "debugManifestErrorDismissButtonText": "Schließen"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Debugskripts zulassen?",
      "debugLoaderLoadingTitle": "Debugladeprogramm zulassen?",
