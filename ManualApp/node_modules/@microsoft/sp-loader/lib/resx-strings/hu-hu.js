define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Nem sikerült betölteni az alkalmazást. Azonosító: {0}, név: {1}.\r\nHiba: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Hiba történt a hibakeresési jegyzék parancsfájljának betöltése közben. Győződjön meg róla, hogy a kiszolgáló fut, és hogy a „debugManifestsFile” paraméter URL-címe helyes.",
      "errorLoadingDebugManifestHTTP": "Hiba történt a hibakeresési jegyzék parancsfájljának betöltése közben. Győződjön meg róla, hogy a kiszolgáló fut, hogy a „debugManifestsFile” paraméter URL-címe helyes, és hogy a nem biztonságos parancsfájlok betöltése engedélyezett. Javasoljuk emellett, hogy használjon fejlesztői tanúsítványt, és hogy a hibakeresési parancsfájlokat HTTPS protokollon keresztül szolgáltassa.",
      "errorLoadingDebugManifestMalformed": "Hiba történt a hibakeresési jegyzék parancsfájljának betöltése közben. A hibakeresési URL ({0}) úgy tűnik, hogy hibás."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "A fejlesztőeszközöket megnyitó „ctrl+shift+0” billentyűkombináció elavult, és hamarosan eltávolítjuk. Használja helyette a „ctrl+F12” billentyűkombinációt."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Hiba történt a hibakeresési jegyzékfájlok betöltésekor.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Engedélyezi a hibakereső parancsprogramokat?",
      "debugLoaderLoadingTitle": "Engedélyezi a hibakereső betöltését?",
