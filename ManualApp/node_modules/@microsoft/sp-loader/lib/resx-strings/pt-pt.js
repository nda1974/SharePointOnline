define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Falha ao carregar a aplicação. ID: \"{0}\", nome: \"{1}\".\r\nErro: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Erro ao carregar o script de manifesto de depuração. Certifique-se de que o servidor está em execução e o URL do parâmetro \"debugManifestsFile\" está correto.",
      "errorLoadingDebugManifestHTTP": "Erro ao carregar o script de manifesto de depuração. Certifique-se de que o servidor está em execução, o URL do parâmetro \"debugManifestsFile\" está correto e o carregamento de scripts inseguros é permitido. Considere também utilizar um certificado de desenvolvimento e apresentar scripts de depuração através de HTTPS.",
      "errorLoadingDebugManifestMalformed": "Erro ao carregar o script de manifesto de depuração. O URL de depuração ({0}) parece estar incorreto."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "A combinação de teclas \"Ctrl+Shift+`\" para abrir as ferramentas de programador foi preterida e será removida brevemente. Em vez disso, utilize a combinação de teclas \"ctrl+F12\"."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Erro ao carregar os manifestos de depuração.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Permitir scripts de depuração?",
      "debugLoaderLoadingTitle": "Permitir o Carregador de Depuração?",
