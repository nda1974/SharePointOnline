define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Не вдалося завантажити програму. Ідентифікатор: {0}; ім’я: {1}.\r\nПомилка: {2}.",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Сталася помилка під час завантаження сценарію маніфесту налагодження. Переконайтеся, що сервер працює та що URL-адресу в параметрі \"debugManifestsFile\" указано правильно.",
      "errorLoadingDebugManifestHTTP": "Сталася помилка під час завантаження сценарію маніфесту налагодження. Переконайтеся, що сервер працює, що URL-адресу в параметрі \"debugManifestsFile\" указано правильно та що дозволено завантаження небезпечних сценаріїв. Також радимо використовувати сертифікат розробки та виконувати сценарії налагодження через HTTPS.",
      "errorLoadingDebugManifestMalformed": "Сталася помилка під час завантаження сценарію маніфесту налагодження. URL-адресу налагодження ({0}) указано неправильно."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Сполучення клавіш Сtrl+Shift+`, за допомогою якого відкриваються інструменти розробника, вилучено та буде видалено найближчим часом. Використовуйте сполучення Ctrl+F12."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Помилка під час завантаження маніфестів налагодження.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Дозволити сценарії налагодження?",
      "debugLoaderLoadingTitle": "Увімкнути завантажувач налагодження?",
