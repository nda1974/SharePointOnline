define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Lietojumprogrammu neizdevās ielādēt. ID: {0}, nosaukums: {1}.\r\nKļūda: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Ielādējot atkļūdošanas manifesta skriptu, radās kļūda. Pārliecinieties, vai serveris darbojas un vai parametra debugManifestsFile vietrādis URL ir pareizs.",
      "errorLoadingDebugManifestHTTP": "Ielādējot atkļūdošanas manifesta skriptu, radās kļūda. Pārliecinieties, vai serveris darbojas, vai parametra debugManifestsFile vietrādis URL ir pareizs un vai nedrošu skriptu ielāde ir atļauta. Apsveriet arī iespēju izmantot izstrādes sertifikātu un apkalpot atkļūdošanas skriptus, izmantojot HTTPS.",
      "errorLoadingDebugManifestMalformed": "Ielādējot atkļūdošanas manifesta skriptu, radās kļūda. Atkļūdošanas vietrādis URL ({0}), šķiet, ir nepareizi veidots."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Taustiņu kombinācija \"Ctrl+Shift+`\" izstrādātāju rīku atvēršanai ir novecojusi un drīz tiks noņemta. Tā vietā izmantojiet taustiņu kombināciju \"Ctrl+F12\"."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Ielādējot atkļūdošanas manifestus, radās kļūda.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Vai atļaut skriptu atkļūdošanu?",
      "debugLoaderLoadingTitle": "Vai atļaut atkļūdošanas ielādētāju?",
