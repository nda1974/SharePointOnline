define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Il caricamento dell'applicazione non è riuscito. ID: \"{0}\", nome: \"{1}\".\r\nErrore: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Errore durante il caricamento dello script del manifesto di debug. Assicurarsi che il server sia in esecuzione e che l'URL del parametro \"debugManifestsFile\" sia corretto.",
      "errorLoadingDebugManifestHTTP": "Errore durante il caricamento dello script del manifesto di debug. Assicurarsi che il server sia in esecuzione, che l'URL del parametro \"debugManifestsFile\" sia corretto e che il caricamento di script non sicuri sia consentito. Considerare inoltre l'uso di un certificato di sviluppo e l'esecuzione degli script di debug su HTTPS.",
      "errorLoadingDebugManifestMalformed": "Errore durante il caricamento dello script del manifesto di debug. Il formato dell'URL di debug ({0}) non è corretto."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "La combinazione di tasti \"CTRL+MAIUSC+`\" per aprire gli strumenti di sviluppo è stata deprecata e verrà rimossa a breve. Usare la combinazione di tasti \"CTRL+F12\"."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Errore durante il caricamento dei manifesti di debug.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Abilitare gli script di debug?",
      "debugLoaderLoadingTitle": "Consentire il caricatore di debug?",
