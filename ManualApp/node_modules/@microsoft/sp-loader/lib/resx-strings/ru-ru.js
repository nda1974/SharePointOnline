define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Не удалось загрузить приложение. Идентификатор: {0}; имя: \"{1}\".\r\n Ошибка: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Ошибка при загрузке сценария манифеста отладки. Убедитесь, что сервер запущен и параметр debugManifestsFile содержит правильный URL-адрес.",
      "errorLoadingDebugManifestHTTP": "Ошибка при загрузке сценария манифеста отладки. Убедитесь, что сервер запущен, параметр debugManifestsFile содержит правильный URL-адрес и разрешена загрузка небезопасных сценариев. Также рассмотрите возможность использования сертификата разработки и обслуживания сценариев отладки по протоколу HTTPS.",
      "errorLoadingDebugManifestMalformed": "Ошибка при загрузке сценария манифеста отладки. Вероятно, URL-адрес отладки ({0}) имеет неправильный формат."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Сочетание клавиш CTRL+SHIFT+' для открытия средств разработчика устарело и скоро перестанет поддерживаться. Вместо него следует использовать сочетание клавиш CTRL+F12."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Ошибка при загрузке манифестов отладки.",
      "debugManifestErrorDetail": "Произошла ошибка при загрузке манифестов отладки.",
      "debugManifestErrorDismissButtonText": "Закрыть"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Разрешить сценарии отладки?",
      "debugLoaderLoadingTitle": "Разрешить загрузчик отладки?",
