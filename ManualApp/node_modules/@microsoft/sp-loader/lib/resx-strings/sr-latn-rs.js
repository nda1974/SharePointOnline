define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Nije uspelo učitavanje aplikacije. ID: „{0}“, ime: „{1}“.\r\nGreška: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Greška prilikom učitavanja skripte manifesta otklanjanja grešaka. Proverite da li je server pokrenut i da li je tačan URL parametara „debugManifestsFile“.",
      "errorLoadingDebugManifestHTTP": "Greška prilikom učitavanja skripte manifesta otklanjanja grešaka. Proverite da li je server pokrenut, da li je tačan URL parametara „debugManifestsFile“ i da li je omogućeno učitavanje nebezbednih skripti. Razmotrite i korišćenje razvojnog certifikata i isporuku skripti za otklanjanje grešaka putem HTTPS protokola.",
      "errorLoadingDebugManifestMalformed": "Greška prilikom učitavanja skripte manifesta otklanjanja grešaka. Izgleda da je URL otklanjanja grešaka ({0}) pogrešno uobličen."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Kombinacija tastera „ctrl+shift+`“ za otvaranje alatki za programere je zastarela i biće uskoro uklonjena. Umesto nje koristite „ctrl+F12“."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Greška prilikom učitavanja manifesta otklanjanja grešaka.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Želite li da dozvolite skripte za otklanjanje grešaka?",
      "debugLoaderLoadingTitle": "Želite li da dozvolite učitavanje otklanjanja grešaka?",
