define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Aplikacija se nije uspjela učitati. ID: \"{0}\", naziv: \"{1}\".\r\nPogreška: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Pogreška pri učitavanju skripte manifesta ispravljanja pogrešaka. Provjerite izvodi li se poslužitelj i je li URL parametra \"debugManifestsFile\" točan.",
      "errorLoadingDebugManifestHTTP": "Pogreška pri učitavanju skripte manifesta ispravljanja pogrešaka. Provjerite izvodi li se poslužitelj, je li URL parametra \"debugManifestsFile\" točan i je li dopušteno učitavanje nepouzdanih skripti. Razmotrite i korištenje certifikata razvoja te posluživanje skripti za ispravljanje pogrešaka putem HTTPS-a.",
      "errorLoadingDebugManifestMalformed": "Pogreška pri učitavanju skripte manifesta ispravljanja pogrešaka. Čini se da je URL za ispravljanje pogrešaka ({0}) oštećen."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Kombinacija tipki \"ctrl+shift+`\" za otvaranje alata za razvojne inženjere zastarjela je i uskoro će biti uklonjena. Umjesto nje, koristite kombinaciju tipki \"ctrl+F12\"."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Prilikom učitavanja manifesta ispravljanja pogrešaka došlo je do pogreške.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Želite li dopustiti skripte za otklanjanje programskih pogrešaka?",
      "debugLoaderLoadingTitle": "Želite li dopustiti alat za učitavanje ispravaka programskih pogrešaka?",
