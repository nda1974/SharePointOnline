define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Error al cargar la aplicación. Id.: \"{0}\", nombre: \"{1}\".\r\nError:{2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Error al cargar el script de manifiesto de depuración. Asegúrese de que se está ejecutando el servidor y la dirección URL del parámetro \"debugManifestsFile\" es correcta.",
      "errorLoadingDebugManifestHTTP": "Error al cargar el script de manifiesto de depuración. Asegúrese de que el servidor se está ejecutando, la dirección URL del parámetro \"debugManifestsFile\" es correcta, y se permite cargar scripts peligrosos. Considere también el uso de un certificado de desarrollo y proporcione los scripts de depuración a través de HTTPS.",
      "errorLoadingDebugManifestMalformed": "Error al cargar el script del manifiesto de depuración. La dirección URL de depuración ({0}) parece tener un formato incorrecto."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "La combinación de teclas \"Ctrl+Mayús+`\" para abrir las herramientas de desarrollo ha quedado obsoleta y se quitará pronto. Utilice la combinación \"Ctrl+F12\" en su lugar."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Error al cargar los manifiestos de depuración.",
      "debugManifestErrorDetail": "Error al cargar los manifiestos de depuración.",
      "debugManifestErrorDismissButtonText": "Descartar"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "¿Desea permitir los scripts de depuración?",
