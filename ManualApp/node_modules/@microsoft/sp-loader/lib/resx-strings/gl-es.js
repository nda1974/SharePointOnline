define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Non se puido cargar a aplicación. ID: \"{0}\"; nome: \"{1}\".\r\nErro: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Erro ao cargar o script do manifesto de depuración. Asegúrate de que o servidor se está executando e que o enderezo do URL do parámetro \"debugManifestsFile\" é correcto.",
      "errorLoadingDebugManifestHTTP": "Erro ao cargar o script do manifesto de depuración. Asegúrate de que o servidor se está executando, que o enderezo do URL do parámetro \"debugManifestsFile\" é correcto e que se permite a carga de scripts non seguros. Considera tamén usar un certificado de desenvolvemento e fornecer scripts de depuración a través de HTTPS.",
      "errorLoadingDebugManifestMalformed": "Erro ao cargar o script do manifesto de depuración. O enderezo URL de depuración ({0}) parece que non é correcto."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "A combinación de teclas \"ctrl+Maiús+`\" para abrir as ferramentas de desenvolvemento está desfasada e eliminarase en breve. Utiliza a combinación de teclas \"ctrl+F12\" no seu lugar."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Erro ao cargar manifestos de depuración.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Queres permitir a depuración de scripts?",
      "debugLoaderLoadingTitle": "Permitir cargador de depuración?",
