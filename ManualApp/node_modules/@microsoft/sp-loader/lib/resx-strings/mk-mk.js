define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Апликацијата не успеа да се вчита. ИД: „{0}“, име: „{1}“.\r\nГрешка: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Грешка при вчитувањето на скриптите од манифестот за отстранување грешки. Проверете дали серверот функционира и дали УРЛ-параметарот „debugManifestsFile“ е точен.",
      "errorLoadingDebugManifestHTTP": "Грешка при вчитувањето на скриптите од манифестот за отстранување грешки. Проверете дали серверот функционира, дали УРЛ-параметарот „debugManifestsFile“ е точен и дали е дозволено вчитување небезбедни скрипти. Размислете и за користење развоен сертификат и за вчитување на скриптите преку HTTPS.",
      "errorLoadingDebugManifestMalformed": "Грешка при вчитувањето на скриптите од манифестот за отстранување грешки. УРЛ-адресата за отстранување грешки ({0}) е лошо формирана."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Комбинацијата на копчиња „ctrl+shift+`“ за отворање на алатките за развивачи е застарена и наскоро ќе се отстрани. Користете ја комбинацијата на копчиња „ctrl+F12“ наместо тоа."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Грешка при вчитувањето на манифестите за отстранување грешки.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Да се дозволат скрипти за отстранување грешки?",
      "debugLoaderLoadingTitle": "Да се дозволи вчитувачот за отстранување грешки?",
