define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Aplikáciu sa nepodarilo načítať. ID: {0}, názov: {1}.\r\nChyba: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Chyba pri načítavaní skriptu manifestu ladenia. Skontrolujte, či je server spustený a či je URL adresa parametra debugManifestsFile správna.",
      "errorLoadingDebugManifestHTTP": "Chyba pri načítavaní skriptu manifestu ladenia. Skontrolujte, či je server spustený, či je URL adresa parametra debugManifestsFile správna a či je povolené načítavanie nebezpečných skriptov. Zvážte aj použitie certifikátu na vývoj a obsluhovanie skriptov ladenia cez protokol HTTPS.",
      "errorLoadingDebugManifestMalformed": "Chyba pri načítavaní skriptu manifestu ladenia. Zdá sa, že URL adresa ladenia ({0}) nie je správna."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Kombinácia klávesov Ctrl + Shift na otvorenie nástrojov vývojára bola zamietnutá a čoskoro bude odstránená. Namiesto toho použite kombináciu klávesov Ctrl + F12."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Chyba pri načítavaní manifestov ladenia.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Chcete povoliť skripty ladenia?",
      "debugLoaderLoadingTitle": "Chcete povoliť zavádzací program ladenia?",
