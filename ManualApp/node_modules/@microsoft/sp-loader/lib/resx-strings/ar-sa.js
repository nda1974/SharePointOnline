define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "فشل تحميل التطبيق. المعرف: \"{0}\"، الاسم: \"{1}\".\r\nالخطأ: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "حدث خطأ أثناء تحميل البرنامج النصي لبيان تتبع الأخطاء. تأكد من تشغيل الخادم ومن صحة عنوان URL المعلمة \"debugManifestsFile\".",
      "errorLoadingDebugManifestHTTP": "حدث خطأ أثناء تحميل البرنامج النصي لبيان تتبع الأخطاء. تأكد من تشغيل الخادم ومن صحة عنوان URL المعلمة \"debugManifestsFile\"، وتأكد من السماح بتحميل البرامج النصية غير الآمنة. ومن المستحسن أيضاً استخدام شهادة تطوير وتوصيل البرامج النصية لتتبع الأخطاء عبر HTTPS.",
      "errorLoadingDebugManifestMalformed": "حدث خطأ أثناء تحميل البرنامج النصي لبيان تتبع الأخطاء. يبدو أن عنوان URL تتبع الأخطاء ({0}) غير صحيح."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "تم إبطال استخدام تركيبة المفاتيح \"ctrl+shift+`‎\" لفتح أدوات المطوّر وستتم إزالتها قريباً. استخدم مجموعة المفاتيح \"ctrl+F12\" بدلاً من ذلك."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "حدث خطأ أثناء تحميل بيانات تتبع الأخطاء.",
      "debugManifestErrorDetail": "حدث خطأ أثناء تحميل بيانات تتبع الأخطاء.",
      "debugManifestErrorDismissButtonText": "تجاهل"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "هل تريد السماح لبرامج تتبع الأخطاء النصية؟",
      "debugLoaderLoadingTitle": "هل تريد السماح بأداة تحميل تتبع الأخطاء؟",
