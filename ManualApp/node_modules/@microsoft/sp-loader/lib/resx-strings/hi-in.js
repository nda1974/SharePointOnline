define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "एप्लिकेशन लोड होने में विफल रहा. Id: \"{0}\" नाम: \"{1}\",\r\nत्रुटि: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "डीबग सूची स्क्रिप्ट लोड करने में त्रुटि. सुनिश्चित करें कि सर्वर चल रहा है और \"debugManifestsFile\" पैरामीटर URL सही है.",
      "errorLoadingDebugManifestHTTP": "डीबग सूची स्क्रिप्ट लोड करने में त्रुटि. सुनिश्चित करें कि सर्वर चल रहा है, \"debugManifestsFile\" पैरामीटर URL सही है और असुरक्षित स्क्रिप्ट्स लोड करने की अनुमति है. डेवलपमेंट प्रमाण पत्र का उपयोग करने और HTTPS पर डीबग स्क्रिप्ट्स सर्व करने पर विचार करें.",
      "errorLoadingDebugManifestMalformed": "डीबग सूची स्क्रिप्ट लोड करने में त्रुटि. डीबग URL ({0}) विकृत लग रहा है."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "डेवलपर उपकरण खोलने के लिए \"ctrl+shift+`\" कुंजी संयोजन डेप्रिकेट कर दिया गया है और शीघ्र ही निकाल दिया आएगा. इसके बजाय \"ctrl+F12\" कुंजी कॉम्बो का उपयोग करें."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "डीबग सूचियाँ लोड करने में त्रुटि.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "डीबग स्क्रिप्ट्स की अनुमति दें?",
      "debugLoaderLoadingTitle": "डीबग लोडर की अनुमति दें?",
