define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Det gick inte att läsa in programmet. ID: \"{0}\", namn: \"{1}\".\r\nFel: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Fel vid inläsning av skript till felsökningsmanifest. Se till att servern är igång och att parameter-URL:en \"debugManifestsFile\" är korrekt.",
      "errorLoadingDebugManifestHTTP": "Fel vid inläsning av skript till felsökningsmanifest. Kontrollera att servern är igång, att URL-adressen till parametern \"debugManifestsFile\" är korrekt, och att det är tillåtet att läsa in osäkra skript. Överväg också att använda ett utvecklingscertifikat och att xxx felsökningsskript via HTTPS.",
      "errorLoadingDebugManifestMalformed": "Fel vid inläsning av skript till felsökningsmanifest. Felsöknings-URL:en ({0}) verkar ha ett felaktigt format."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Tangentkombination \"Ctrl+Skift+`\" för att öppna utvecklarverktygen är inaktuell och tas snart bort. Använd tangentkombinationen \"Ctrl+F12\" istället."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Fel vid inläsning av felsökningsmanifest.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Tillåta felsökning av skript?",
      "debugLoaderLoadingTitle": "Tillåta Debug Loader?",
