define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Le chargement de l’application a échoué. ID : « {0} » ; nom : « {1} ».\r\nErreur : {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Une erreur s’est produite lors du chargement du script du manifeste de débogage. Assurez-vous que le serveur est en cours d’exécution et que l’URL du paramètre « debugManifestsFile » est approprié.",
      "errorLoadingDebugManifestHTTP": "Une erreur s’est produite lors du chargement du script du manifeste de débogage. Assurez-vous que le serveur est en cours d’exécution, que l’URL du paramètre « debugManifestsFile » est appropriée et que le chargement de scripts non sécurisés est autorisé. Envisagez également d’utiliser un certificat de développement et de proposer des scripts de débogage via HTTPS.",
      "errorLoadingDebugManifestMalformed": "Une erreur s’est produite lors du chargement du script du manifeste de débogage. Le format de l’URL de débogage ({0}) semble incorrect."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "La combinaison de touches « Ctrl+Maj+` » pour ouvrir les outils de développement a été désaffectée et sera supprimée prochainement. Utilisez la combinaison de touches « Ctrl+F12 » à la place."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Une erreur s’est produite lors du chargement des manifestes de débogage.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Voulez-vous autoriser les scripts de débogage ?",
      "debugLoaderLoadingTitle": "Voulez-vous autoriser le chargeur de débogage ?",
