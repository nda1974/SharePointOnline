define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Aplicația nu a reușit să se încarce. ID: „{0}”, nume: „{1}”.\r\nEroare: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Eroare la încărcarea scriptului manifestului de depanare. Asigurați-vă că serverul rulează și URL-ul din parametrul „debugManifestsFile” este corect.",
      "errorLoadingDebugManifestHTTP": "Eroare la încărcarea scriptului manifestului de depanare. Asigurați-vă că serverul rulează, URL-ul din parametrul „debugManifestsFile” este corect și că încărcarea de scripturi nesigure este permisă. De asemenea, luați în considerare utilizarea unui certificat de dezvoltator și servirea scripturilor de depanare prin HTTPS.",
      "errorLoadingDebugManifestMalformed": "Eroare la încărcarea scriptului manifestului de depanare. URL-ul de depanare ({0}) pare a fi greșit format."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Combinația de taste „ctrl+shift+`” pentru deschiderea instrumentelor pentru dezvoltatori este perimată și va fi eliminată în curând. Utilizați în schimb combinația de taste „ctrl+F12”."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Eroare la încărcarea manifestelor de depanare.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Permiteți scripturile de depanare?",
      "debugLoaderLoadingTitle": "Permiteți instrumentul de încărcare a depanării?",
