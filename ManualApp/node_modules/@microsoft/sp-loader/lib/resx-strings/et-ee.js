define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Rakenduse laadimine nurjus. ID: \"{0}\", nimi: \"{1}\".\r\nTõrge: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Tõrge silumismanifestide skripti laadimisel. Kontrollige, kas server töötab ja URL-parameeter \"debugManifestsFile\" on õige .",
      "errorLoadingDebugManifestHTTP": "Tõrge silumismanifestide skripti laadimisel. Kontrollige, kas server töötab, URL-parameeter \"debugManifestsFile\" on õige ja ebaturvaliste skriptide laadimine on lubatud. Võiksite kasutada ka arendusserti ja silumisskriptide teenindamist HTTPS-i kaudu.",
      "errorLoadingDebugManifestMalformed": "Tõrge silumismanifestide skripti laadimisel. Silumise URL ({0}) näib olevat moonutatud."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Arendusriistade avamiseks mõeldud klahvikombinatsioon Ctrl+Shift+` on iganenud ja eemaldatakse peagi. Kasutage selle asemel klahvikombinatsiooni Ctrl+F12."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Tõrge silumismanifestide laadimisel.",
      "debugManifestErrorDetail": "Silumismanifestide laadimisel ilmnes tõrge.",
      "debugManifestErrorDismissButtonText": "Unusta"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Kas soovite lubada silumisskriptid?",
      "debugLoaderLoadingTitle": "Kas soovite lubada silumislaaduri?",
