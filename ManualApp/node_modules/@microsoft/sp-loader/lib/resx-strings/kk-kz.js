define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Бағдарламаны жүктеу сәтсіз аяқталды. Идентификатор: \"{0}\". Атауы: \"{1}\". \r\nҚате: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Күйін келтіру манифестінің сценарийін жүктеу кезінде қате пайда болды. Сервер жұмыс істеп тұрғанына және \"debugManifestsFile\" параметрінің URL мекенжайы дұрыс екеніне көз жеткізіңіз.",
      "errorLoadingDebugManifestHTTP": "Күйін келтіру манифестінің сценарийін жүктеу кезінде қате пайда болды. Сервер жұмыс істеп тұрғанына, \"debugManifestsFile\" параметрінің URL мекенжайы дұрыс екеніне және қауіпті сценарийлерді жүктеуге рұқсат етілгеніне көз жеткізіңіз. Сондай-ақ, HTTPS протоколдары бойынша әзірлеу сертификатын пайдалану және реттеу сценарийлеріне қызмет көрсету мүмкіндігін қараңыз.",
      "errorLoadingDebugManifestMalformed": "Күйін келтіру манифестінің сценарийін жүктеу кезінде қате пайда болды. Күйін келтірудің URL мекенжайының ({0}) пішімі қате болу мүмкін."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Әзірлеуші құралдарын ашуға арналған \"ctrl+shift+`\" пернелер тіркесімі ескірген және жақын арада жойылады. Оның орнына \"ctrl+F12\" пернелер тіркесімін пайдаланыңыз."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Күйін келтіру манифестерін жүктеу кезінде қате пайда болды.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Күйін келтіру сценарийлеріне рұқсат ету қажет пе?",
      "debugLoaderLoadingTitle": "Күйін келтіруге арналған жүктеу құралына рұқсат ету қажет пе?",
