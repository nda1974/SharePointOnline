define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "응용 프로그램을 로드하지 못했습니다. ID: \"{0}\", 이름: \"{1}\".\r\n오류: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "디버그 매니페스트 스크립트를 로드하는 중 오류가 발생했습니다. 서버가 실행 중이며 \"debugManifestsFile\" 매개 변수 URL이 정확한지 확인하세요.",
      "errorLoadingDebugManifestHTTP": "디버그 매니페스트 스크립트를 로드하는 중 오류가 발생했습니다. 서버가 실행 중이고, \"debugManifestsFile\" 매개 변수 URL이 정확하며, 안전하지 않은 스크립트 로드가 허용되었는지 확인하세요. 또한 개발 인증서 사용 및 HTTPS를 통한 디버그 스크립트 제공도 고려하세요.",
      "errorLoadingDebugManifestMalformed": "디버그 매니페스트 스크립트를 로드하는 중 오류가 발생했습니다. 디버그 URL({0})의 형식이 잘못된 것 같습니다."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "\"ctrl+shift+`\" 개발자 도구를 여는 \"ctrl+shift+`\" 키 조합이 더 이상 사용되지 않으며 곧 제거됩니다. \"Ctrl + F12\" 키 조합을 대신 사용하세요."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "디버그 매니페스트 로드 중 오류가 발생했습니다.",
      "debugManifestErrorDetail": "디버그 매니페스트 로드 중 오류가 발생했습니다.",
      "debugManifestErrorDismissButtonText": "해제"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "디버그 스크립트를 허용하시겠습니까?",
      "debugLoaderLoadingTitle": "디버그 로더를 허용하시겠습니까?",
