define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Falha ao carregar o aplicativo. ID: \"{0}\", nome: \"{1}\".\r\nErro: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Erro ao carregar o script de manifesto de depuração. Verifique se o servidor está em execução e se a URL do parâmetro \"debugManifestsFile\" está correta.",
      "errorLoadingDebugManifestHTTP": "Erro ao carregar o script de manifesto de depuração. Verifique se que o servidor está em execução, se a URL do parâmetro \"debugManifestsFile\" está correta, e se é permitido carregar scripts perigosos. Além disso, considere usar um certificado de desenvolvimento e atender a scripts de depuração em HTTPS.",
      "errorLoadingDebugManifestMalformed": "Erro ao carregar o script de manifesto de depuração. A URL de depuração ({0}) parece estar incorreta."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "A combinação de teclas \"Ctrl+Shift+`\" para abrir as ferramentas de desenvolvedor foi substituída e será removida em breve. Use a combinação de teclas \"ctrl+F12\" em vez disso."
    },
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      ...
      "debugLoaderLoadingTitle": "Permitir Carregador de Depuração?",
