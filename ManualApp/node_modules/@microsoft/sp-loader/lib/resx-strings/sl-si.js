define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Aplikacije ni bilo mogoče naložiti. ID: »{0}«, ime: »{1}«.\r\nNapaka: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Med nalaganjem iskanja napak v skriptu manifesta je prišlo do napake. Preverite, ali strežnik deluje in ali je URL parametra »debugManifestsFile« pravilen.",
      "errorLoadingDebugManifestHTTP": "Med nalaganjem iskanja napak v skriptu manifesta je prišlo do napake. Preverite, ali strežnik deluje, ali je URL parametra »debugManifestsFile« pravilen in ali je dovoljeno nalaganje nevarnih skriptov. Uporabite lahko tudi potrdilo o razvoju in podajanju skriptov za iskanje prek protokola HTTPS.",
      "errorLoadingDebugManifestMalformed": "Med nalaganjem iskanja napak v skriptu manifesta je prišlo do napake. Videti je, da je URL ({0}), vključen v iskanje napak, poškodovan."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Kombinacija tipk »ctrl+shift+`« za odpiranje orodij za razvijalce je v postopku odstranjevanja. Namesto tega uporabite kombinacijo »ctrl+F12«."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Med nalaganjem iskanja napak v manifestu je prišlo do napake.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Ali želite dovoliti iskanje napak v skriptih?",
      "debugLoaderLoadingTitle": "Ali želite dovoliti iskanje napak v nalagalniku?",
