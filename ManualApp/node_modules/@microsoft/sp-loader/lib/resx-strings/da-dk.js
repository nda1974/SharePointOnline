define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Programmet kunne ikke indlæses. Id: \"{0}\", navn: \"{1}\".\r\nFejl: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Der opstod en fejl under indlæsning af fejlfindingsmanifestscriptet. Kontrollér, at serveren kører og at URL-adressen for parameteren \"debugManifestsFile\" er korrekt.",
      "errorLoadingDebugManifestHTTP": "Der opstod en fejl under indlæsning af fejlfindingsmanifestscriptet. Kontrollér, at serveren kører, at URL-adressen for parameteren \"debugManifestsFile\" er korrekt, og at indlæsning af usikre scripts er tilladt. Overvej også at bruge et certifikat til udvikling og at betjene fejlfindingsscripts ved hjælp af HTTPS.",
      "errorLoadingDebugManifestMalformed": "Der opstod en fejl under indlæsning af fejlfindingsmanifestscriptet. URL-adressen ({0}) til fejlfinding er tilsyneladende forkert udformet."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "\"Ctrl+skift+`\"-tastekombinationen til at åbne udviklingsværktøjer frarådes, og vil blive fjernet snart. Brug \"ctrl+F12\"-tastekombinationen i stedet."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Der opstod en fejl under indlæsning af fejlfindingsmanifester.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Vil du tillade fejlfindingsscripts?",
      "debugLoaderLoadingTitle": "Vil du tillade Debug Loader?",
