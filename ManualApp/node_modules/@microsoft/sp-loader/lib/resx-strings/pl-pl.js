define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Nie można załadować aplikacji. Identyfikator: „{0}”. Nazwa: „{1}”.\r\nBłąd: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Wystąpił błąd podczas ładowania skryptu manifestu debugowania. Upewnij się, serwer jest uruchomiony, a parametr adresu URL „debugManifestsFile” jest poprawny.",
      "errorLoadingDebugManifestHTTP": "Wystąpił błąd podczas ładowania skryptu manifestu debugowania. Upewnij się, że serwer jest uruchomiony, parametr adresu URL „debugManifestsFile” jest poprawny, a ładowanie niebezpiecznych skryptów jest dozwolone. Rozważ również użycie certyfikatu opracowywania i obsługiwanie skryptów debugowania za pomocą protokołu HTTPS.",
      "errorLoadingDebugManifestMalformed": "Wystąpił błąd podczas ładowania skryptu manifestu debugowania. Adres URL debugowania ({0}) prawdopodobnie jest źle sformułowany."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Kombinacja klawiszy „Ctrl+Shift+`” umożliwiająca otwarcie narzędzi deweloperskich jest przestarzała i wkrótce zostanie usunięta. Zamiast tego użyj kombinacji klawiszy „Ctrl+F12”."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Błąd podczas ładowania manifestów debugowania.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Zezwolić na skrypty debugowania?",
      "debugLoaderLoadingTitle": "Zezwolić na moduł ładujący debugowania?",
