define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Không tải được ứng dụng. Id: \"{0}\", tên: \"{1}\".\r\nLỗi: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Lỗi khi tải tập lệnh tệp kê khai gỡ lỗi. Hãy đảm bảo rằng máy chủ đang chạy và URL tham số \"debugManifestsFile\" là chính xác.",
      "errorLoadingDebugManifestHTTP": "Lỗi khi tải tập lệnh tệp kê khai gỡ lỗi. Hãy đảm bảo rằng máy chủ đang chạy, URL tham số \"debugManifestsFile\" là chính xác và đã cho phép tải các tập lệnh không an toàn. Đồng thời, hãy xem xét việc sử dụng chứng chỉ phát triển và cung cấp tập lệnh gỡ lỗi qua HTTPS.",
      "errorLoadingDebugManifestMalformed": "Lỗi khi tải tập lệnh tệp kê khai gỡ lỗi. Có vẻ như URL gỡ lỗi ({0}) không có định dạng chuẩn."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Tổ hợp phím \"ctrl+shift+`\" để mở các công cụ cho nhà phát triển đã bị chấm dứt và sẽ sớm bị loại bỏ. Hãy sử dụng tổ hợp phím \"ctrl+F12\" thay vào đó."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Lỗi trong khi tải tệp kê khai gỡ lỗi.",
      "debugManifestErrorDetail": "Đã xảy ra lỗi khi tải tệp kê khai gỡ lỗi.",
      "debugManifestErrorDismissButtonText": "Bỏ"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Cho phép gỡ lỗi tập lệnh?",
      "debugLoaderLoadingTitle": "Cho phép Trình tải Gỡ lỗi?",
