define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Није успело учитавање апликације. ID: „{0}“, име: „{1}“.\r\nГрешка: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Грешка приликом учитавања скрипте манифеста отклањања грешака. Проверите да ли је сервер покренут и да ли је тачан URL параметара „debugManifestsFile“.",
      "errorLoadingDebugManifestHTTP": "Грешка приликом учитавања скрипте манифеста отклањања грешака. Проверите да ли је сервер покренут, да ли је тачан URL параметара „debugManifestsFile“ и да ли је омогућено учитавање небезбедних скрипти. Размотрите и коришћење развојног цертификата и испоруку скрипти за отклањање грешака путем HTTPS протокола.",
      "errorLoadingDebugManifestMalformed": "Грешка приликом учитавања скрипте манифеста отклањања грешака. Изгледа да је URL отклањања грешака ({0}) погрешно уобличен."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Комбинација тастера „ctrl+shift+`“ за отварање алатки за програмере је застарела и биће ускоро уклоњена. Уместо ње користите „ctrl+F12“."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Грешка приликом учитавања манифеста отклањања грешака.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Желите ли да дозволите скрипте за отклањање грешака?",
      "debugLoaderLoadingTitle": "Желите ли да дозволите учитавање отклањања грешака?",
