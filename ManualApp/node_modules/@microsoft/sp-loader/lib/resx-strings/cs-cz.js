define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Aplikaci se nepovedlo načíst. ID: {0}, název: {1}.\r\nChyba: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Chyba při načítání skriptu pro manifesty ladění. Zkontrolujte, jestli server běží a parametr debugManifestsFile obsahuje správnou adresu URL.",
      "errorLoadingDebugManifestHTTP": "Chyba při načítání skriptu pro manifesty ladění. Zkontrolujte, jestli server běží, parametr debugManifestsFile obsahuje správnou adresu URL a je povolené načítání nezabezpečených skriptů. Zvažte také použití certifikátu pro vývoj a obsluhování ladicích skriptů přes HTTPS.",
      "errorLoadingDebugManifestMalformed": "Chyba při načítání skriptu pro manifesty ladění. Vypadá to, že adresa URL pro ladění ({0}) nemá správný formát."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Klávesová zkratka Ctrl+Shift+` pro spuštění nástrojů pro vývojáře je zastaralá a brzo ji odebereme. Používejte místo ní kombinaci Ctrl+F12."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Chyba při načítání manifestů ladění",
      "debugManifestErrorDetail": "Došlo k chybě při načítání manifestů ladění.",
      "debugManifestErrorDismissButtonText": "Zavřít"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Chcete povolit ladění skriptů?",
      "debugLoaderLoadingTitle": "Povolit zavaděč ladění?",
