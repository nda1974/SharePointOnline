define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Kan ikke laste inn programmet. ID: {0}, navn: {1}.\r\nFeil: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Feil under innlasting av manifestskript for feilsøking. Kontroller at serveren kjører og at nettadressen til parameteren debugManifestsFile er riktig.",
      "errorLoadingDebugManifestHTTP": "Feil under innlasting av manifestskript for feilsøking. Kontroller at serveren kjører, at nettadressen til parameteren debugManifestsFile er riktig og at det er tillatt å laste inn usikre skript. Vurder også å bruke et utviklingssertifikat, og kjøre feilsøkingsskript over HTTPS.",
      "errorLoadingDebugManifestMalformed": "Feil under innlasting av manifestskript for feilsøking. Nettadressen for feilsøking ({0}) ser ut til å være feilformatert."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Tastekombinasjonen Ctrl+Skift+` for å åpne utviklerverktøy er foreldet og fjernes snart. Bruk tastekombinasjonen Ctrl+F12 i stedet."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Feil under innlasting av feilsøkingsmanifester.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Tillate feilsøkingsskript?",
      "debugLoaderLoadingTitle": "Tillate feilsøkelaster?",
