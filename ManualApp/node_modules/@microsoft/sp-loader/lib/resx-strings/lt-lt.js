define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Taikomosios programos įkelti nepavyko. ID: „{0}“, pavadinimas: „{1}“.\r\nKlaida: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Klaida įkeliant derinimo deklaracijos scenarijų. Įsitikinkite, kad serveris veikia, ir parametro „debugManifestsFile“ URL yra teisingas.",
      "errorLoadingDebugManifestHTTP": "Klaida įkeliant derinimo deklaracijos scenarijų. Įsitikinkite, kad serveris veikia, parametro „debugManifestsFile“ URL yra teisingas, ir leidžiama įkelti nesaugius scenarijus. Taip pat apsvarstykite galimybę naudoti kūrimo sertifikatą ir derinimo scenarijų teikimą per HTTPS.",
      "errorLoadingDebugManifestMalformed": "Klaida įkeliant derinimo deklaracijos scenarijų. Atrodo, kad derinimo URL ({0}) yra sudarytas netinkamai."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Klavišų kombinacija ctrl + shift +`, skirta kūrėjo įrankiams atidaryti, yra pasenusi ir netrukus bus pašalinta. Vietoj jos naudokite klavišų kombinaciją ctrl + F12."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Klaida įkeliant derinimo deklaracijas.",
      "debugManifestErrorDetail": "Įkeliant derinimo deklaracijas, įvyko klaida.",
      "debugManifestErrorDismissButtonText": "Atsisakyti"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Leisti derinimo scenarijus?",
      "debugLoaderLoadingTitle": "Leisti derinimo įkėlimo priemonę?",
