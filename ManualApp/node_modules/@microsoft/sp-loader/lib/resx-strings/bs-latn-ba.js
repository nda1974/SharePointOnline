define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Aplikacije se nije uspjela učitati. ID: \"{0}\", naziv: \"{1}\".\r\nGreška: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Greška pri učitavanju skripte manifesta za otklanjanje grešaka. Provjerite je li server pokrenut i je li parametar URL veze \"debugManifestsFile\" tačan.",
      "errorLoadingDebugManifestHTTP": "Greška pri učitavanju skripte manifesta za otklanjanje grešaka. Provjerite je li server pokrenut, je li parametar URL veze \"debugManifestsFile\" tačan te je li dopušteno učitavanje nesigurnih skripti. Također razmotrite korištenje razvojnog certifikata i opsluživanje skripti za otklanjanje grešaka koristeći HTTPS.",
      "errorLoadingDebugManifestMalformed": "Greška pri učitavanju skripte manifesta za otklanjanje grešaka. URL veze za otklanjanje grešaka ({0}) se čini pogrešno formiranim."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Greška pri učitavanju manifesta za uklanjanje grešaka.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Dopustiti skripte za ispravljanje grešaka?",
      "debugLoaderLoadingTitle": "Dozvoli program za učitavanje za ispravljanje grešaka?",
