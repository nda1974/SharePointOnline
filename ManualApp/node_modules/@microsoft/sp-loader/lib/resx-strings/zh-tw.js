define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "應用程式無法載入。識別碼: \"{0}\"，名稱: \"{1}\"。\r\n錯誤: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "載入偵錯資訊清單指令碼時發生錯誤。請確定伺服器正在執行中且 \"debugManifestsFile\" 參數 URL 正確無誤。",
      "errorLoadingDebugManifestHTTP": "載入偵錯資訊清單指令碼時發生錯誤。請確定伺服器正在執行中、\"debugManifestsFile\" 參數 URL 正確無誤，且允許載入不安全的指令碼。也請考慮使用開發憑證和透過 HTTPS 提供偵錯指令碼。",
      "errorLoadingDebugManifestMalformed": "載入偵錯資訊清單指令碼時發生錯誤。偵錯 URL ({0}) 的格式錯誤。"
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "用以開啟開發人員工具的 \"ctrl+shift+`\" 按鍵組合已過時，很快就會移除。請改為使用 \"ctrl + F12\" 按鍵組合。"
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "載入偵錯資訊清單時發生錯誤。",
      "debugManifestErrorDetail": "載入偵錯資訊清單時發生錯誤。",
      "debugManifestErrorDismissButtonText": "關閉"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "是否允許偵錯指令碼?",
      "debugLoaderLoadingTitle": "是否允許偵錯載入器?",
