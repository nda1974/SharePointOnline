define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "بارگذاری برنامه ناکام ماند. Id: \"{0}\", اسم: \"{1}\".\r\nخطا: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "خطا در بارگذاری اسکرپت اظهارنامه عیب زدایی. اطمینان حاصل کنید که سرور فعال است، URL پارامتر \"debugManifestsFile\" درست است.",
      "errorLoadingDebugManifestHTTP": "خطا در بارگذاری اسکرپت اظهارنامه عیب زدایی. اطمینان حاصل کنید که سرور فعال است، URL پارامتر \"debugManifestsFile\" درست است، و بارگذاری اسکرپت ناامن اجازه داده شده است. و نیز استفاده از تصدیقنامه انکشاف و خدمات اسکرپت های عیب زدایی در HTTPS را مدنظر بگیرید.",
      "errorLoadingDebugManifestMalformed": "خطا در بارگذاری اسکرپت اظهارنامه عیب زدایی. معلوم میشود که URL ({0}) ناقص شکل باشد."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "ترکیب کلید های \"ctrl+shift+`\" برای بازکردن اسباب انکشاف دهنده موجب نارضایتی شده و بزودی دورساخته خواهد شد. به عوض، از ترکیب کلیدهای \"ctrl+F12\" استفاده کنید."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "خطا در بارگذاری اظهارنامه های عیب زدایی.",
      "debugManifestErrorDetail": "در بارگذاری اظهارنامه های عیب زدایی خطایی رخ داد.",
      "debugManifestErrorDismissButtonText": "رد کردن"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "اسکرپت های عیب زدایی اجازه داده شوند؟",
      "debugLoaderLoadingTitle": "به بارگذار عیب زدایی اجازه داده شود؟",
