define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "应用程序加载失败。ID:“{0}”，名称:“{1}”。\r\nE错误: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "加载调试清单脚本时出错。请确保服务器正在运行且 \"debugManifestsFile\" 参数 URL 正确。",
      "errorLoadingDebugManifestHTTP": "加载调试清单脚本时出错。请确保服务器正在运行，\"debugManifestsFile\" 参数 URL 正确，且允许加载不安全的脚本。同时考虑使用开发证书并通过 HTTPS 处理调试脚本。",
      "errorLoadingDebugManifestMalformed": "加载调试清单脚本时出错。调试 URL ({0})貌似格式出错。"
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "用于打开开发人员工具的 \"Ctrl+shift+`\" 组合键已弃用，并将很快被删除。请改为使用 \"Ctrl+F12\" 组合键。"
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "加载调试清单时出错。",
      "debugManifestErrorDetail": "加载调试清单时出错。",
      "debugManifestErrorDismissButtonText": "忽略"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "允许使用调试脚本?",
      "debugLoaderLoadingTitle": "是否允许调试加载程序?",
