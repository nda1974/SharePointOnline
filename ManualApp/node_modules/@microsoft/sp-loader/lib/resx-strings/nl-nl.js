define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Laden van toepassing is mislukt. Id: {0}, naam: {1}.\r\nFout: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Fout bij het laden van scripts voor foutopsporingsmanifesten. Controleer of de server actief is en de URL voor de parameter DebugManifestsFile juist is.",
      "errorLoadingDebugManifestHTTP": "Fout bij het laden van scripts voor foutopsporingsmanifesten. Controleer of de server actief is, de URL voor de parameter DebugManifestsFile juist is en of het laden van onveilige scripts is toegestaan. Overweeg ook om een ontwikkelingscertificaat te gebruiken en scripts voor foutopsporing via HTTPS te verwerken.",
      "errorLoadingDebugManifestMalformed": "Fout bij het laden van scripts voor foutopsporingsmanifesten. De foutopsporings-URL ({0}) is waarschijnlijk onjuist."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "De toetsencombinatie Ctrl+Shift+` voor het openen van de ontwikkelhulpprogramma's is afgeschaft en wordt binnenkort verwijderd. Gebruik in plaats hiervan de combinatie Ctrl+F12."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Fout bij het laden van foutopsporingsmanifesten.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Scripts voor foutopsporing toestaan?",
      "debugLoaderLoadingTitle": "Lader voor foutopsporing toestaan?",
