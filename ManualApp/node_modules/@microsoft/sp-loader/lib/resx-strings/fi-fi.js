define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Sovelluksen lataaminen epäonnistui. Tunnus: {0}, nimi: {1}.\r\nVirhe: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Virhe ladattaessa virheenkorjauskokoonpanotietojen komentosarjaa. Varmista, että palvelin toimii ja että debugManifestsFile-parametrin URL on oikea.",
      "errorLoadingDebugManifestHTTP": "Virhe ladattaessa virheenkorjauskokoonpanotietojen komentosarjaa. Varmista, että palvelin toimii, debugManifestsFile-parametrin URL on oikea ja vahingollisten komentosarjojen lataaminen sallitaan. Harkitse myös kehitysvarmenteen käyttämistä ja virheenkorjauskomentosarjojen lähettämistä HTTPS-protokollan välityksellä.",
      "errorLoadingDebugManifestMalformed": "Virhe ladattaessa virheenkorjauskokoonpanotietojen komentosarjaa. Virheenkorjaus-URL ({0}) vaikuttaa virheellisesti muotoillulta."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Kehittäjän työkalujen avaamiseen käytetty näppäinyhdistelmä Ctrl+Vaihto+` on vanhentunut ja poistuu pian käytöstä. Käytä sen sijaan näppäinyhdistelmää Ctrl+F12."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Virhe ladattaessa virheenkorjauskokoonpanotietoja.",
      "debugManifestErrorDetail": "Virhe ladattaessa virheenkorjauskokoonpanotietoja.",
      "debugManifestErrorDismissButtonText": "Hylkää"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Sallitaanko komentosarjojen virheenkorjaus?",
      "debugLoaderLoadingTitle": "Sallitaanko virheenkorjauksen latausohjelma?",
