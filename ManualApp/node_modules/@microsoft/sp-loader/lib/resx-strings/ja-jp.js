define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "アプリケーションの読み込みに失敗しました。ID: \"{0}\"、名前: \"{1}\"。\r\nエラー: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "デバッグのマニフェストのスクリプトの読み込み中にエラーが発生しました。サーバーが実行中で、\"debugManifestsFile\" パラメーターの URL が正しいことを確認してください。",
      "errorLoadingDebugManifestHTTP": "デバッグのマニフェストのスクリプトの読み込み中にエラーが発生しました。サーバーが実行中で、\"debugManifestsFile\" パラメーターの URL が正しいことを確認し、安全でないスクリプトの読み込みが許可されていることを確認してください。開発証明書を使用して、HTTPS 経由でのデバッグ スクリプトを提供することを検討してください。",
      "errorLoadingDebugManifestMalformed": "デバッグのマニフェストのスクリプトの読み込み中にエラーが発生しました。デバッグの URL ({0}) が不正な形式である可能性があります。"
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "開発者ツールを開くための \"Ctrl + Shift + `\" キーの組み合わせは廃止され、間もなく削除されます。代わりに \"Ctrl + F12\" キーの組み合わせを使用してください。"
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "デバッグのマニフェストを読み込み中にエラーが発生しました。",
      "debugManifestErrorDetail": "デバッグのマニフェストの読み込み中にエラーが発生しました。",
      "debugManifestErrorDismissButtonText": "閉じる"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "スクリプトのデバッグを許可しますか?",
      "debugLoaderLoadingTitle": "デバッグ ローダーを許可しますか?",
