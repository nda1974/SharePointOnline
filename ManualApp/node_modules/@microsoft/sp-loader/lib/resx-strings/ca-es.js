define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "No s'ha pogut carregar la aplicació. Id.: \"{0}\", nom: \"{1}\".\r\nError: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Error en carregar l'script del manifest de depuració. Assegureu-vos que el servidor funcioni i que l'URL del paràmetre \"debugManifestsFile\" sigui correcte.",
      "errorLoadingDebugManifestHTTP": "Error en carregar l'script del manifest de depuració. Assegureu-vos que el servidor funcioni, que l'URL del paràmetre \"debugManifestsFile\" sigui correcte i que es permeti l'opció per carregar scripts no segurs. També us recomanem utilitzar un certificat de desenvolupament i publicar els scripts de depuració a través d'HTTPS.",
      "errorLoadingDebugManifestMalformed": "Error en carregar l'script del manifest de depuració. Sembla que l'URL de depuració ({0}) té un format incorrecte."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "La combinació de tecles \"Ctrl+Maj+`\" per obrir les eines de desenvolupador s'ha deixat d'utilitzar i aviat se suprimirà. Podeu fer servir la combinació \"Ctrl+F12\"."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Error en carregar els manifestos de depuració.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Voleu permetre els scripts de depuració?",
      "debugLoaderLoadingTitle": "Voleu permetre el carregador de depuració?",
