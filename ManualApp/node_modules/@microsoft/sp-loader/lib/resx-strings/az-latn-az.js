define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Proqram yüklənilmədi. İd: \"{0}\", adı: \"{1}\".\r\nSəhv: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Sazlama bəyannaməsi skriptini yükləyən zaman səhv baş verdi. Serverin icra olunduğuna, \"debugManifestsFile\" parametri URL-nin düzgün olduğuna əmin olun.",
      "errorLoadingDebugManifestHTTP": "Sazlama bəyannaməsi skriptini yükləyən zaman səhv baş verdi. Serverin icra olunduğuna, \"debugManifestsFile\" parametri URL-nin düzgün olduğuna və təhlükəli skriptlərin yüklənməsinə icazə verilib-verilmədiyinə əmin olun. Bundan başqa, tərtibat sertifikatından istifadəni və HTTPS vasitəsilə sazlama skriptlərinin xidmət etdiyini nəzərə alın.",
      "errorLoadingDebugManifestMalformed": "Sazlama bəyannaməsi skriptini yükləyən zaman səhv baş verdi. Görünür, sazlama URL-i ({0}) korlanıb."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Tərtibatçı alətlərini açmaq üçün \"ctrl+shift+`\" düyməsi birləşməsi tövsiyə olunmur və tezliklə silinəcəkdir. Əvəzində \"ctrl+F12\" düymə birləşməsindən istifadə edin."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Sazlama bəyannaməsini yükləyən zaman səhv.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Sazlama skriptlərinə icazə verilsin?",
      "debugLoaderLoadingTitle": "Sazlama Yükləyicisinə icazə verilsin?",
