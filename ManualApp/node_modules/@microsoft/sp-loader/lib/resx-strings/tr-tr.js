define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Uygulama yüklenemedi. Kimlik: \"{0}\", ad: \"{1}\"\r\nHata: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Hata ayıklama bildirimi betiği yüklenirken bir hata oluştu. Sunucunun çalıştığından ve \"debugManifestsFile\" parametre URL'sinin doğru olduğundan emin olun.",
      "errorLoadingDebugManifestHTTP": "Hata ayıklama bildirimi betiği yüklenirken bir hata oluştu. Sunucunun çalıştığından, \"debugManifestsFile\" parametre URL'sinin doğru olduğundan ve güvenli olmayan betiklerin yüklenmesine izin verildiğinden emin olun. Ayrıca geliştirme sertifikası kullanmayı ve hata ayıklama betiklerini HTTPS üzerinden sunmayı düşünün.",
      "errorLoadingDebugManifestMalformed": "Hata ayıklama bildirimi betiği yüklenirken bir hata oluştu. Hata ayıklama URL'si ({0}) hatalı oluşturulmuş gibi görünüyor."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Geliştirici araçlarını açmak için kullanılan \"ctrl+shift+`\" tuş birleşimi kullanım dışı bırakıldı ve yakında kaldırılacak. Bunun yerine \"ctrl+F12\" tuş birleşimini kullanın."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Hata ayıklama bildirimleri yüklenirken bir hata oluştu.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Hata ayıklama betiklerine izin verilsin mi?",
      "debugLoaderLoadingTitle": "Hata Ayıklama Yükleyicisine izin verilsin mi?",
