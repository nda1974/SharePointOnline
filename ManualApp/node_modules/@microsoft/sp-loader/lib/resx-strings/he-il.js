define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "טעינת היישום נכשלה. מזהה: \"{0}\", שם: \"{1}\".\r\nשגיאה: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "שגיאה בטעינת קובץ Script של מניפסט איתור באגים. ודא שהשרת פועל ושכתובת ה- URL של הפרמטר \"debugManifestsFile\" היא נכונה.",
      "errorLoadingDebugManifestHTTP": "שגיאה בטעינת קובץ Script של מניפסט איתור באגים. ודא שהשרת פועל, שכתובת ה- URL של הפרמטר \"debugManifestsFile\" היא נכונה, ושמותר לטעון קבצי Script לא בטוחים. בנוסף, שקול להשתמש באישור פיתוח ולהגיש קבצי Script של איתור באגים באמצעות HTTPS.",
      "errorLoadingDebugManifestMalformed": "שגיאה בטעינת קובץ Script של מניפסט איתור באגים. נראה שלכתובת ה- URL של איתור באגים ({0}) יש מבנה פגום."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "צירוף המקשים \"ctrl+shift+`‎\" לפתיחת כלי הפיתוח יצא משימוש והוא יוסר בקרוב. השתמש בצירוף המקשים \"ctrl+F12\" במקום זאת."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "שגיאה בטעינת מניפסטים של איתור באגים.",
      "debugManifestErrorDetail": "אירעה שגיאה בעת טעינת מניפסטים של איתור באגים.",
      "debugManifestErrorDismissButtonText": "הפסק"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "האם לאפשר קבצי Script לאיתור באגים?",
      "debugLoaderLoadingTitle": "האם לאפשר טוען לאיתור באגים?",
