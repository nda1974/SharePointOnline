define([], function() {
  var strings = {
    "_nQNACBeQ34aV6bVwtFBayA": {
      ...
      "applicationFailedToLoadWithMessageError": "Приложението не можа да се зареди. ИД: \"{0}\", име: \"{1}\".\r\nГрешка: {2}",
    ...
    "_kf4jigwPPCxeciwsfHc9rA": {
      "errorLoadingDebugManifestHTTPS": "Грешка при зареждане на скрипт на манифест за отстраняване на грешки. Уверете се, че сървърът работи и че URL адресът на параметъра \"debugManifestsFile\" е правилен.",
      "errorLoadingDebugManifestHTTP": "Грешка при зареждане на скрипт на манифест за отстраняване на грешки. Уверете се, че сървърът работи, че URL адресът на параметъра \"debugManifestsFile\" е правилен и че зареждането на опасни скриптове е позволено. Също така обмислете използване на сертификат за разработки и обслужващи скриптове за отстраняване на грешки по HTTPS.",
      "errorLoadingDebugManifestMalformed": "Грешка при зареждане на скрипт на манифест за отстраняване на грешки. URL адресът за отстраняване на грешки ({0}) изглежда деформиран."
    },
    ...
    "_CmyT6Anz+yC/KJh8Pcbu5g": {
      "developerToolsKeyComboDeprecationMessage": "Клавишната комбинация \"ctrl+shift+`\" за отваряне на инструментите за разработчици е спряна и скоро ще бъде премахната. Използвайте клавишната комбинация \"ctrl+F12\" вместо нея."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorTitle": "Грешка при зареждане на манифестите за отстраняване на грешки.",
    ...
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "debugManifestLoadingTitle": "Позволяване на отстраняване на грешки от скриптовете?",
      "debugLoaderLoadingTitle": "Разрешаване на зареждащия модул за отстраняване на грешки?",
