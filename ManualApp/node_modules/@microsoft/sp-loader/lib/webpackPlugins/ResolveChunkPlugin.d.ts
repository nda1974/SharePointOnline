// [ts-npm-lint] removed reference to 'webpackTypes.d.ts'
/**
 ...
 *  type in TypeScript. The same example code could be written this way if this plugin is installed:
 *
 * Code you write:
 ...
 * This should be open-sourced, but that'll take time.
 */
