...
var AstStructuredType_1 = require("./AstStructuredType");
var AstEnum_1 = require("./AstEnum");
var AstFunction_1 = require("./AstFunction");
var AstItem_1 = require("./AstItem");
var AstItemContainer_1 = require("./AstItemContainer");
var AstNamespace_1 = require("./AstNamespace");
...
/**
  ...
  */
var AstPackage = (function (_super) {
    __extends(AstPackage, _super);
    function AstPackage(extractor, rootFile) {
        var _this = _super.call(this, AstPackage._getOptions(extractor, rootFile)) || this;
        _this._exportedNormalizedSymbols = [];
        _this.kind = AstItem_1.AstItemKind.Package;
            ...
            for (var _i = 0, exportSymbols_1 = exportSymbols; _i < exportSymbols_1.length; _i++) {
                ...
                for (var _a = 0, _b = followedSymbol.declarations; _a < _b.length; _a++) {
                    ...
                    if (followedSymbol.flags & (ts.SymbolFlags.Class | ts.SymbolFlags.Interface)) {
                        _this.addMemberItem(new AstStructuredType_1.default(options));
                    }
                    else if (followedSymbol.flags & ts.SymbolFlags.ValueModule) {
                        _this.addMemberItem(new AstNamespace_1.default(options));
                    }
                    else if (followedSymbol.flags & ts.SymbolFlags.Function) {
                        _this.addMemberItem(new AstFunction_1.default(options));
                    }
                    else if (followedSymbol.flags & ts.SymbolFlags.Enum) {
                        _this.addMemberItem(new AstEnum_1.default(options));
                    }
                    else {
    ...
    AstPackage._getOptions = function (extractor, rootFile) {
     ...
     * the string "MyClass".
     */
    AstPackage.prototype.tryGetExportedSymbolName = function (symbol) {
    ...
    AstPackage.prototype.shouldHaveDocumentation = function () {
        // We don't write JSDoc for the AstPackage object
        return false;
    };
    return AstPackage;
}(AstItemContainer_1.default));
