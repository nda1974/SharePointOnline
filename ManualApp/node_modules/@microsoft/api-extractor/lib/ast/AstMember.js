 ...
 */
var AstMember = (function (_super) {
    __extends(AstMember, _super);
    function AstMember(options) {
        ...
        if (memberSignature.modifiers) {
            for (var _i = 0, _a = memberSignature.modifiers; _i < _a.length; _i++) {
                ...
                if (modifier.kind === ts.SyntaxKind.PublicKeyword) {
                    _this.accessModifier = ApiAccessModifier.Public;
                }
                else if (modifier.kind === ts.SyntaxKind.ProtectedKeyword) {
                    _this.accessModifier = ApiAccessModifier.Protected;
                }
                else if (modifier.kind === ts.SyntaxKind.PrivateKeyword) {
                    _this.accessModifier = ApiAccessModifier.Private;
                }
        ...
        if (memberSignature.type && memberSignature.type.kind === ts.SyntaxKind.TypeLiteral) {
            ...
            _this.typeLiteral = new AstStructuredType_1.default(typeLiteralOptions);
     ...
     * @virtual
     */
    AstMember.prototype.visitTypeReferencesForAstItem = function () {
     ...
     */
    AstMember.prototype.getDeclarationLine = function (property) {
        if (this.typeLiteral || !!property) {
            var accessModifier = this.accessModifier ? ApiAccessModifier[this.accessModifier].toLowerCase() : undefined;
