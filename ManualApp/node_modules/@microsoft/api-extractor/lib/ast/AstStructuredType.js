...
var AstMethod_1 = require("./AstMethod");
var AstProperty_1 = require("./AstProperty");
...
/**
  ...
  */
var AstStructuredType = (function (_super) {
    __extends(AstStructuredType, _super);
    function AstStructuredType(options) {
        ...
        if (_this.declarationSymbol.flags & ts.SymbolFlags.Interface) {
            _this.kind = AstItem_1.AstItemKind.Interface;
        }
        else if (_this.declarationSymbol.flags & ts.SymbolFlags.TypeLiteral) {
            _this.kind = AstItem_1.AstItemKind.TypeLiteral;
        }
        else {
            _this.kind = AstItem_1.AstItemKind.Class;
        }
     ...
     * @virtual
     */
    AstStructuredType.prototype.visitTypeReferencesForAstItem = function () {
        _super.prototype.visitTypeReferencesForAstItem.call(this);
    ...
    /**
      ...
      */
    AstStructuredType.prototype.getDeclarationLine = function () {
        var result = '';
    ...
    AstStructuredType.prototype._processMember = function (memberSymbol, memberDeclaration) {
