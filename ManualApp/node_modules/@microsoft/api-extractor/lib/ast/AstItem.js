 ...
 */
var AstItem = (function () {
    function AstItem(options) {
        /**
     ...
     */
    AstItem.prototype.notifyAddedToContainer = function (parentContainer) {
     ...
     */
    AstItem.prototype.visitTypeReferencesForAstItem = function () {
        // (virtual)
    };
    /**
     ...
     */
    AstItem.prototype.getDeclaration = function () {
     ...
     *       an appropriate member to avoid the need for this.
     */
    AstItem.prototype.getDeclarationSymbol = function () {
     ...
     */
    AstItem.prototype.shouldHaveDocumentation = function () {
        return true;
    };
    Object.defineProperty(AstItem.prototype, "parentContainer", {
        /**
     ...
     */
    AstItem.prototype.completeInitialization = function () {
        switch (this._state) {
     ...
     */
    AstItem.prototype.hasAnyIncompleteTypes = function () {
     ...
     */
    AstItem.prototype.followAliases = function (symbol) {
        var current = symbol;
        while (true) {
     ...
     */
    AstItem.prototype.reportError = function (message) {
     ...
     */
    AstItem.prototype.reportWarning = function (message) {
     ...
     * the documentation.
     */
    AstItem.prototype.onCompleteInitialization = function () {
        ...
        if (this.kind === AstItemKind.Package) {
            if (this.documentation.releaseTag !== ReleaseTag_1.ReleaseTag.None) {
                var tag = '@' + ReleaseTag_1.ReleaseTag[this.documentation.releaseTag].toLowerCase();
     ...
     */
    AstItem.prototype.visitTypeReferencesForNode = function (node) {
     ...
     */
    AstItem.prototype._analyzeTypeReference = function (typeReferenceNode) {
        ...
        var resolvedAstItem = this.extractor.docItemLoader.resolveJsonReferences(apiDefinitionRef, referenceResolutionWarnings);
        if (resolvedAstItem) {
