...
var AstModuleVariable_1 = require("./AstModuleVariable");
...
/**
  ...
  */
var AstNamespace = (function (_super) {
    __extends(AstNamespace, _super);
    function AstNamespace(options) {
        var _this = _super.call(this, options) || this;
        _this._exportedNormalizedSymbols = [];
        _this.kind = AstItem_1.AstItemKind.Namespace;
        ...
        if (exportSymbols) {
            for (var _i = 0, exportSymbols_1 = exportSymbols; _i < exportSymbols_1.length; _i++) {
                ...
                _this.addMemberItem(new AstModuleVariable_1.default(exportMemberOptions));
