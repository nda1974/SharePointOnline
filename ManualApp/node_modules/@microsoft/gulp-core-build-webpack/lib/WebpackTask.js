...
var WebpackTask = (function (_super) {
    ...
    function WebpackTask(extendedName, extendedConfig) {
        return _super.call(this, extendedName || 'webpack', __assign({ configPath: './webpack.config.js', suppressWarnings: [], printStats: true }, extendedConfig) // tslint:disable-line:no-any
        ) || this;
    }
                    ...
                    statsResultChildren.forEach(function (child) {
                        if (child.chunks) {
                            child.chunks.forEach(function (chunk) {
                                if (chunk.files && _this.taskConfig.printStats) {
