...
var ConfigureWebpackTask_1 = require("@microsoft/sp-build-core-tasks/lib/configureWebpack/ConfigureWebpackTask");
...
var SPWebBuildRig = (function (_super) {
    ...
    SPWebBuildRig.prototype.getCoreBuildTask = function () {
        return sp_build_common_1.parallel(sp_build_common_1.serial(gulp_core_build_sass_1.default, _super.prototype.getCoreBuildTask.call(this)), gulp_core_build_1.copyStaticAssets);
    };
