...
var ExtensionManager = (function () {
    ...
    ExtensionManager.prototype.createExtension = function (componentId, propertiesJson, contextCreator) {
        ...
        if (true) {
            var manifest_1 = sp_loader_1.SPComponentLoader.tryGetManifestById(componentId);
            if (!manifest_1) {
            ...
            try {
                ...
                var createPromise = modulePromise.then(function (component) {
                    ...
                    return extension._init(context_1, propertiesJson).then(function () {
                        ...
                        error_1 = new Error(sp_core_library_1.Text.format(ExtensionStrings_resx_1.default.extensionInitFailure, componentId));
                        qosMonitor.writeExpectedFailure('ExtensionInitFailure', error_1, extraData_1);
                        throw error_1;
                    });
                }, function (e) {
                    if (!error_1) {
                        error_1 = new Error(sp_core_library_1.Text.format(ExtensionStrings_resx_1.default.extensionLoadFailure, componentId));
                        qosMonitor.writeExpectedFailure('ExtensionLoadFailure', error_1, extraData_1);
                    }
                    throw error_1;
