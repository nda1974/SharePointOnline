...
declare abstract class BaseClientSideWebPart<TProperties> extends BaseComponent {
    ...
    /**
     * Cache init properties value, it would be used to check whether web part has been change or not.
     */
     ...
     */
    private _internalFirstTimeRender(addedFromPersistedData, mode?, qosMonitor?, data?, scrollableParent?);
    /**
     * @internal
     */
